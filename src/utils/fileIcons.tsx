export default {
    ...
    excel: (
      <g transform="translate(14 10)">
        <path d="M19.5 3H12v1.5h2.25v2.25H12V8.25h2.25v2.25H12v1.5h2.25V14.25H12v1.5h7.5c.413 0 .75-.337.75-.75V3.75c0-.413-.337-.75-.75-.75zm-.75 11.25h-3v-2.25h3v2.25zm0-3.75h-3V8.25h3v2.25zm0-3.75h-3V4.5h3v2.25z" fillRule="evenodd" />
        <path d="M0 1.5v15l10.5 1.5V0L0 1.5zm6.488 10.725L5.25 9.75l-1.238 2.475H2.25l2.063-3.225L2.438 5.775h1.725L5.25 8.063l1.088-2.288h1.724L6.188 9l2.062 3.225H6.488z" fillRule="evenodd" />
      </g>
    ),
    // Microsoft Word
    word: (
      <g transform="translate(14 10)">
        <path d="M19.5 3H12v1.5h7.5V3zm0 3H12v1.5h7.5V6zm0 3H12v1.5h7.5V9zm0 3H12v1.5h7.5V12zm0 3H12v1.5h7.5V15z" fillRule="evenodd" />
        <path d="M0 1.5v15l10.5 1.5V0L0 1.5zm7.5 10.875H6L5.25 8.25l-.75 4.125H3L1.5 5.625h1.313l.937 4.5.75-4.5H6l.75 4.5.938-4.5H9L7.5 12.375z" fillRule="evenodd" />
      </g>
    ),
    // Microsoft PowerPoint
    powerpoint: (
      <g transform="translate(14 10)">
        <path d="M19.5 3H12v13.5h7.5c.413 0 .75-.337.75-.75V3.75c0-.413-.337-.75-.75-.75zm-3 9.75a3.75 3.75 0 1 1 0-7.5v3.75h3.75a3.75 3.75 0 0 1-3.75 3.75z" fillRule="evenodd" />
        <path d="M17.25 5.25v3h3a3 3 0 0 0-3-3z" fillRule="evenodd" />
        <path d="M0 1.5v15l10.5 1.5V0L0 1.5zm6.75 8.25H4.5v2.625H3V5.625h3.75c1.243 0 2.25 1.007 2.25 2.25a2.252 2.252 0 0 1-2.25 1.875zm0-2.625H4.5V8.25h2.25a.75.75 0 0 0 0-1.5v-.125z" fillRule="evenodd" />
      </g>
    ),
    // Markdown - file with pen (editable document)
    markdown: (
    ...
    text: (
      <g transform="translate(15 11)">
        <path d="M0 0v4h2V2h3v10H3v2h6v-2H7V2h3v2h2V0H0z" fillRule="evenodd" />
      </g>
    ),
    // OneNote
    onenote: (
      <g transform="translate(14 10)">
        <path d="M19.5 3H12v1.5h7.5V3zm0 3H12v1.5h7.5V6zm0 3H12v1.5h7.5V9zm0 3H12v1.5h7.5V12zm0 3H12v1.5h7.5V15z" fillRule="evenodd" />
        <path d="M0 1.5v15l10.5 1.5V0L0 1.5zm7.5 10.875H6V8.25L4.5 12.375H3V5.625h1.5v4.125l1.5-4.125h1.5v6.75z" fillRule="evenodd" />
      </g>
    ),
    // Outlook/Email
    outlook: (
      <g transform="translate(14 10)">
        <path d="M19.5 4.5H12v9h7.5c.413 0 .75-.337.75-.75v-7.5c0-.413-.337-.75-.75-.75zm-.75 6l-3-2.25-3 2.25v-1.5l3-2.25 3 2.25v1.5z" fillRule="evenodd" />
        <path d="M0 1.5v15l10.5 1.5V0L0 1.5zm5.25 11.25c-2.07 0-3.75-1.68-3.75-3.75S3.18 5.25 5.25 5.25 9 6.93 9 9s-1.68 3.75-3.75 3.75zm0-6A2.252 2.252 0 0 0 3 9c0 1.24 1.01 2.25 2.25 2.25S7.5 10.24 7.5 9 6.49 6.75 5.25 6.75z" fillRule="evenodd" />
      </g>
    ),
    android: (
      <path
