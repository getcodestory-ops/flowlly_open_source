...
export default function BidLevelling2({
	...
	const [formId] = useState(() => `bid_levelling_2_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`);
		...
		<div className="max-w-[816px] mx-auto bg-white shadow-sm border border-gray-200 min-h-[900px]">
			...
			<div className="px-12 py-10 lg:px-16 lg:py-12">
				...
				<h1 className="text-3xl font-normal text-gray-900 mb-4">
					Bid Levelling (comprehensive)
				</h1>

				{/* Description */}
				<p className="text-gray-600 mb-10 leading-relaxed">
					Detailed bid analysis with task tracking. Choose your bid documents and provide additional context for analysis. 
					Click on the attachment icon and select files from the side panel by selecting the context.
				</p>
				...
				<div className="mb-12">
					...
					<DocTextArea
						...
						onChange={(value) => handleInputChange("optionalInstructions", value)}
