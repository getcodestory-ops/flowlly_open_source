	...
	return (
        ...
        >
          ...
          <FaCode />
					...
					<Popover>
						<PopoverTrigger>
							<ToolTipedButton onClick={() => {}} tooltip="Insert Chart">
								<FaChartBar />
							</ToolTipedButton>
						</PopoverTrigger>
						<PopoverContent className="w-80">
							<div className="grid gap-4">
								<div className="space-y-2">
									<h4 className="font-medium leading-none">Insert Chart</h4>
									<p className="text-sm text-muted-foreground">
										Choose a chart type to insert.
									</p>
								</div>
								<div className="grid gap-2">
									<Button
										onClick={() => {
											const sampleLineChart = {
												...
												elements: [
													{
														label: "Sample Data",
														points: [[1, 10], [2, 20], [3, 15], [4, 25], [5, 30]],
													},
												],
												x_label: "X-axis",
												y_label: "Y-axis",
											};
											const directive = `:::chart\n${JSON.stringify(sampleLineChart, null, 2)}\n:::`;
											editor.commands.insertContent(directive);
										}}
									>
										Line Chart
									</Button>
									<Button
										onClick={() => {
											...
											const directive = `:::chart\n${JSON.stringify(sampleBarChart, null, 2)}\n:::`;
											editor.commands.insertContent(directive);
										}}
									>
										Bar Chart
									...
									<Button
										onClick={() => {
											...
											const directive = `:::chart\n${JSON.stringify(samplePieChart, null, 2)}\n:::`;
											editor.commands.insertContent(directive);
										}}
									>
										Pie Chart
									...
									<Button
										onClick={() => {
											...
											const directive = `:::chart\n${JSON.stringify(emptyChart, null, 2)}\n:::`;
											editor.commands.insertContent(directive);
										}}
										variant="outline"
									>
